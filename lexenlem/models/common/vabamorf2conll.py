...
VERB_FEATURES = {
    'MOOD=indic': ['b', 'd', 'n', 'nud', 's', 'sid', 'o', 'sime', 'sin', 'site', 'ta', 'takse', 'te', 'ti', 'vad'],
    'MOOD=cond': [
        'ks',
        'ksid',
        'ksime',
...
AMBIGUOUS_VERB_FEATURES = {
    ('NUMBER=sg', 'NUMBER=pl'): ['ks', 'nud', 'nuks', 'nuvat', 'vat', 'o', 'gu'],
...
def neural_model_tags(word: str, pos: str, form: str):
    """
