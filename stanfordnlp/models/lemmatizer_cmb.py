...
from stanfordnlp.models.lemma.data import DataLoaderCombined
from stanfordnlp.models.lemma.vocab import Vocab
from stanfordnlp.models.lemma.trainer import TrainerCombined
...
def train(args):
    ...
    train_batch = DataLoaderCombined(args['train_file'], args['batch_size'], args, evaluation=False)
    vocab = train_batch.vocab
    args['vocab_size'] = vocab['combined'].size
    dev_batch = DataLoaderCombined(args['eval_file'], args['batch_size'], args, vocab=vocab, evaluation=True)
