...
def parse_args():
    ...
    parser.add_argument('--pos_first', action='store_true', help='Put UPOS before the source during training')
    parser.add_argument('--feats', action='store_true', help='Use FEATS in lemmatization.')
    parser.add_argument('--feats_first', action='store_true', help='Put FEATS before UPOS and source during training')
    ...
    parser.add_argument('--vabamorf', action='store_true', help='Add Vabamorf predictions to the input')
    parser.add_argument('--vabamorf_first', action='store_true', help='Put Vabamorf predictions before FEATS, UPOS and source during training')
...
def train(args):
    ...
    args['feats_vocab_size'] = vocab['feats'].size
